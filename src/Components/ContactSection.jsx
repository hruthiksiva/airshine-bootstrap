  ...
  return (
      <div className='container-fluid py-5 my-5 domestic-section'>
        ...
        <div className='row d-flex justify-content-center align-items-center text-center'>
          <div className='col-12 col-md-3 px-4 lh-lg'>
            <h5>Contact us</h5>
            <p className='lh-sm grey'>
              Call Us : <span className='purple-font'>+919585557593</span>
              <br />Email : contact@airshineonline.com
            </p>
          </div>
          <div className='col-12 col-md-3 px-4 lh-lg'>
            <h5>Opening Hours</h5>
          ...
          <div className='col-12 col-md-3 px-4 lh-lg'>
            <h5>Our Chennai Office</h5>
            <p className='lh-sm grey'>Chennai, India</p>
          </div>
        </div>
      </div>
